...
class ViewController: UIViewController {
    ...
    var activatedButtonns = [UIButton]()
    ...
    @objc func letterTapped(_ sender: UIButton){
        ...
        activatedButtonns.append(sender)
        //Project 15 changes
    ...
    @objc func submitTapped(_ sender: UIButton){
        ...
        if let solutionPosition = solutions.firstIndex(of: answerText){
            ...
            currentAnswer.text = ""
            score += 1
            correctlyAnswered += 1 //challenge 3
            
            //challenge3, compare correctlyAnswered rather than score
            
            if correctlyAnswered % 7 == 0 && level == 1{
            ...
            } else if correctlyAnswered % 7 == 0 && level == 2{
                let ac = UIAlertController(title: "Well done!", message: "You finished the game!", preferredStyle: .alert)
    ...
    @objc func clearTapped(_ sender: UIButton){
        ...
        for button in activatedButtonns{
            button.isHidden = false
        }
